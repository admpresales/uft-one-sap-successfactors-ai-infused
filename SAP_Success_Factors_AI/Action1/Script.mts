...
End If
'================================================================================================
Browser("Browser").ClearCache																	'Clears the browser cache
...
Set IconAnchor = AIUtil("profile", micAnyText, micFromTop, 1)									'Set the IconAnchor to be the profile icon
...
'15.0.1 Computer vision wasn't recognizing it as a input class AIUtil("text_box", "Enter Password").Type DataTable.GlobalSheet.GetParameter("Password")		'Enter the password fromt he datasheet into the Password field
AIUtil("input", "Enter Password").Type DataTable.GlobalSheet.GetParameter("Password")		'Enter the password fromt he datasheet into the Password field
...
'===========================================================================================
AIUtil("button", micAnyText, micFromBottom, 3).Click											'Click the Search button via more generic description to ensure it will run on 15.0.1 as well
